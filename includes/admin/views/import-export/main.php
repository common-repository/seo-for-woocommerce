...
<div class="wrap rank-math-wrap">
	...
	<h1 class="page-title"><?php esc_html_e( 'Import &amp; Export', 'seo-for-woocommerce' ); ?></h1>

	<p style="font-size: 1rem;">
		<?php
		/* translators: Link to learn about import export panel KB article */
		printf( esc_html__( 'Import your previous backed up setting. Or, Export your Rank Math settings and meta data for backup or for reuse on (another) blog. %s', 'seo-for-woocommerce' ), '<a href="https://rankmath.com/kb/import-export-settings/" target="_blank">' . esc_html__( 'Learn more about the Import/Export option.', 'seo-for-woocommerce' ) . '</a>' );
		?>
	</p>
